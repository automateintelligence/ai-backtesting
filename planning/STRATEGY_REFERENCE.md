...
**File**: `qse/strategies/stock_basic.py`
...
**File**: `qse/strategies/stock_sma_trend.py`
...
**File**: `qse/strategies/stock_rsi_reversion.py`
...
**File**: `qse/strategies/option_call.py`
...
**File**: `qse/strategies/option_atm_call_momentum.py`
...
**File**: `qse/strategies/option_atm_put_rsi.py`
...
All canonical strategies use shared position sizing utilities from `qse/strategies/position_sizing.py`.
...
Strategies are registered in `qse/strategies/factory.py`:
...
**Implemented**: `qse/features/technical.py` provides comprehensive technical indicator calculations.
...
```python
from qse.features.technical import compute_all_features
...
### Strategies
1. `qse/strategies/position_sizing.py` - Position sizing utilities
2. `qse/strategies/stock_sma_trend.py` - SMA trend following
3. `qse/strategies/stock_rsi_reversion.py` - RSI mean reversion
4. `qse/strategies/option_atm_call_momentum.py` - ATM call momentum
5. `qse/strategies/option_atm_put_rsi.py` - ATM put RSI

### Feature Computation
6. `qse/features/technical.py` - Technical indicator calculations (RSI, SMA, EMA, MACD, Bollinger Bands, ATR, Stochastic)

### Tests
7. `tests/integration/test_strategies_with_features.py` - Integration tests for strategies with feature computation

**Modified**:
- `qse/strategies/factory.py` - Registered new strategies
- `qse/simulation/compare.py` - Added automatic feature computation
